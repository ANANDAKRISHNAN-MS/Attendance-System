        ...
        if(List.length===0){
            ...
            <div class="course-card-content">
              <div class="course-info">
                <h3 class="course-title">Currently You Are Not Learning Any Courses</h3>
              </div>
            </div>
          </div>`
          cardContent.innerHTML = noCourse
            ...
            const courseList= List.map(item=>{
                ...
                <div class="course-card-content">
                  ...
                  <a href="../course.html?studentid=${student_id}&&id=${tcc_code}&&code=${course_code}&&name=${course_name}" class="view-link"><p>View</p><svg
